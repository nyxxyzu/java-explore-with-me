...
import ru.practicum.event.repositories.CommentRepository;
import ru.practicum.event.repositories.EventRepository;
import ru.practicum.event.repositories.LocationRepository;
import ru.practicum.event.repositories.RequestRepository;
...
public class EventServiceImpl implements EventService {
	...
	public CommentDto postComment(NewCommentDto dto, Long userId, Long eventId) {
		...
		Comment comment = EventMapper.toComment(dto);
